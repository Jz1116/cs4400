...
export const TESTER_WORKAT_API_URL = `${TESTER_API_URL}/workat`;
export const UNIQUE_SITE_API_URL = `${SITE_API_URL}/unique`;
export const SITE_WITH_ONLY_ONE_TESTER_API_URL = `${SITE_API_URL}/only`;
export const UNIQUE_APPT_API_URL = `${APPT_API_URL}/unique`;
export const UNIQUE_USER_API_URL = `${USER_API_URL}/unique`;
...
export const STUDENT_REGISTER_API_URL = `${STUDENT_API_URL}/register`;
export const STUDENT_REGISTER_APPT_API_URL = `${STUDENT_REGISTER_API_URL}/appt`;
export const POOL_RESULT_API_URL = `${POOL_API_URL}/result`;
export const POOL_DATA_API_URL = `${POOL_API_URL}/data`;
export const PROCESS_POOL_API_URL = `${POOL_API_URL}/process`;
export const POOL_TESTS_API_URL = `${POOL_API_URL}/tests`;
...
export const PROCESS_TEST_API_URL = `${TEST_API_URL}/process`;
